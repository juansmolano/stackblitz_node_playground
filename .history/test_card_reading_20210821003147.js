...
const MIFARE_DEFAULT_KEY_B = process.env.MIFARE_DEFAULT_KEY_B || '00000000000000000000000000000000';
...
const serverLogicByStep = {
    ...
    0: (paymentMedium, currentStep, responseApdus) => {
        ...
        const apduBytes = MifareTools.generateFirstAuthPhaseIApdu(0, true);
        nextStep.apdus.push(MifareTools.bytesToHex(apduBytes));
        nextStep.nextStep = 1;
    ...
    1: (paymentMedium, currentStep, responseApdus) => {
        console.log('=====', { step: currentStep, responseApdus });
        const nextStep = { nextStep: null, apdus: [] };
        ...
        let firstAuthPhase1 = MifareTools.hexToBytes(responseApdu.response.substring(2));
        firstAuthPhase1 = MifareTools.hexToBytes('09FEAAF9A70AFFAA2C2E1004E84CCD21');
        /* generating next step apdus */
        const apduBytes = MifareTools.generateFirstAuthPhaseIIApdu(firstAuthPhase1, MifareTools.hexToBytes(MIFARE_DEFAULT_KEY_B));
        nextStep.apdus.push(MifareTools.bytesToHex(apduBytes));
        nextStep.nextStep = 2;

        return nextStep;
    },
    2: (paymentMedium, currentStep, responseApdus) => {
        console.log('=====', { step: currentStep, responseApdus });
        const nextStep = { nextStep: null, apdus: [] };
        ...
        // /* generating next step apdus */
        // const apduBytes = MifareTools.generateFirstAuthPhaseIIApdu(firstAuthPhase1, MIFARE_DEFAULT_KEY_B);
        // nextStep.apdus.push(MifareTools.bytesToHex(apduBytes));
        // nextStep.nextStep = 2;
