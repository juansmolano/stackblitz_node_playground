...
const serverLogicByStep = {
    ...
    0: (paymentMedium, currentStep, responseApdus) => {
        ...
        const apduBytes = MifareTools.generateFirstAuthPhaseIApdu(4, true);
    ...
    2: (paymentMedium, currentStep, responseApdus) => {
        ...
        const { keyEnc, keyMac } = MifareTools.extractParametersFromFirstAuthResult(firstAuthPhase2, paymentMedium.emissionSteps.processVars);
        paymentMedium.emissionSteps.processVars = { ...paymentMedium.emissionSteps.processVars, keyEnc, keyMac };
