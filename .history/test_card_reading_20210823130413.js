...
const serverLogicByStep = {
    ...
    2: (paymentMedium, currentStep, responseApdus) => {
        ...
        // /* generating next step apdus */
        const apdu = MifareTools.generateReadCmdApdu(BLOCK_EXT, paymentMedium.emissionSteps.processVars);
        nextStep.apdus.push(MifareTools.bytesToHex(apdu));
        nextStep.nextStep = 3;

        return nextStep;
    },
    3: (paymentMedium, currentStep, responseApdus) => {
        ...
        const ParametersFromFirstAuth = MifareTools.extractParametersFromFirstAuthResult();
        // paymentMedium.emissionSteps.processVars = { ...paymentMedium.emissionSteps.processVars, ...ParametersFromFirstAuth };
