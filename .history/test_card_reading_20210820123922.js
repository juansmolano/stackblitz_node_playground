...
const serverLogicByStep = {
    ...
    //     console.log('=====', { step, responseApdus });
    //     return { nextStep: 2, apdus: ['FFCA000000'] };
    // },
    ...new Array(10).fill((paymentMedium, step, responseApdus) => {
        console.log('=====', { step, responseApdus });
        return { nextStep: step === 9 ? null : step + 1, apdus: new Array(step).fill('FFCA000000') };
    })
};
