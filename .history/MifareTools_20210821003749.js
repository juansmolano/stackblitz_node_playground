...
class MifareTools {
    ...
    static generateFirstAuthPhaseIIApdu(rndBc, key) {
        ...
        let rndA = [...randomBytes(16)];
        const rndD = [...rndA, ...rndBr];
        const rndDc = this.encrypt(rndD, key, iv);

        rndA = this.hexToBytes('80A3020012050109FEAAF9A70AFFAA2C2E1004E84CCD2100');
//10876FFD4F87030A2966F8EC235AAA30747DE0B870C523C25D4A53A5A3B71CCA90AF

        const res = { iv, rndB, rndBr, rndA, rndD, rndDc };
