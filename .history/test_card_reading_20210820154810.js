...
/* ENV VARS */
MIFARE_DEFAULT_KEY_A = process.env.MIFARE_DEFAULT_KEY_A || '00000000000000000000000000000000';
MIFARE_DEFAULT_KEY_B = process.env.MIFARE_DEFAULT_KEY_B || '00000000000000000000000000000000';
...
const serverLogicByStep = {
    ...
    0: (paymentMedium, currentStep, responseApdus) => {
        ...
        nextStep.apdus.push(apduBytes.map(b=>b.toString(16)));
