...
class PaymentMediumMifareInterpreter {
    ...
    cardDataMapToBinary(cardDataMap) {
        const binaryData =
            this.mappingVersion.mapping.EMISSION_VARS.APPS
                .map(appCode => this.mappingVersion.mapping[appCode].data)
                .reduce((acc, data) => {
    ...
    binaryToCardDataMap(binaryData) {
        ...
        return this.mappingVersion.mapping.EMISSION_VARS.APPS
            .map(appCode => this.mappingVersion.mapping[appCode].data)
